...
@str.1 = internal constant [12 x i8] c"assign2o.cl\00"
...
ok.0:
	...
	%vtpm.14 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.13
	%vtpm.15 = call %Main*(%Main*, i32 )%vtpm.14( %Main* %vtpm.9, i32 %vtpm.8 )
	%vtpm.16 = load %Main*, %Main** %vtpm.0
	%vtpm.17 = bitcast %Main* %vtpm.16 to %Object*
	ret %Object* %vtpm.17
...
entry:
	...
	%vtpm.22 = call i8*(i32 ) @malloc( i32 %vtpm.21 )
...
ok.1:
	...
	%vtpm.26 = getelementptr %Main, %Main* %vtpm.23, i32 0, i32 1
