...
entry:
	...
	%vtpm.11 = call i8*(i32 ) @malloc( i32 %vtpm.10 )
...
ok.0:
	...
	store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.14
	store %Main* %vtpm.12, %Main** %vtpm.8
