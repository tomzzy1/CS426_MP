...
@String.2 = constant %String {
	%_String_vtable* @_String_vtable_prototype,
	i8* getelementptr ([3 x i8], [3 x i8]* @str.2, i32 0, i32 0)
}
...
ok.0:
	...
	%vtpm.13 = load i1 (%Main*) *, i1 (%Main*) ** %vtpm.12
	%vtpm.14 = call i1(%Main* )%vtpm.13( %Main* %vtpm.8 )
	br i1 %vtpm.14, label %true.0, label %false.0

true.0:
	%vtpm.15 = load %Main*, %Main** %vtpm.6
...
ok.1:
	...
	%vtpm.20 = load %Main* (%Main*,%String*) *, %Main* (%Main*,%String*) ** %vtpm.19
	%vtpm.21 = call %Main*(%Main*, %String* )%vtpm.20( %Main* %vtpm.15, %String* @String.2 )
	store %Main* %vtpm.21, %Main** %vtpm.7
	br label %end.0

false.0:
	%vtpm.22 = load %Main*, %Main** %vtpm.6
...
ok.2:
	...
	%vtpm.27 = load %Main* (%Main*,%String*) *, %Main* (%Main*,%String*) ** %vtpm.26
	%vtpm.28 = call %Main*(%Main*, %String* )%vtpm.27( %Main* %vtpm.22, %String* @String.1 )
	store %Main* %vtpm.28, %Main** %vtpm.7
	br label %end.0

end.0:
	%vtpm.29 = load %Main*, %Main** %vtpm.7
...
ok.3:
	...
	store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.39
	store %Main* %vtpm.37, %Main** %vtpm.33
	%vtpm.40 = getelementptr %Main, %Main* %vtpm.37, i32 0, i32 1
	store %Main* null, %Main** %vtpm.40
	ret %Main* %vtpm.37
