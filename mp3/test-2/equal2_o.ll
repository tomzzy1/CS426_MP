...
@str.3 = internal constant [3 x i8] c"s1\00"
@String.3 = constant %String {
	%_String_vtable* @_String_vtable_prototype,
	i8* getelementptr ([3 x i8], [3 x i8]* @str.3, i32 0, i32 0)
}

@str.4 = internal constant [12 x i8] c"equal2_o.cl\00"
@String.4 = constant %String {
	%_String_vtable* @_String_vtable_prototype,
	i8* getelementptr ([12 x i8], [12 x i8]* @str.4, i32 0, i32 0)
}
...
entry:
	...
	%vtpm.2 = bitcast %String* @String.3 to i8*
	%vtpm.3 = bitcast %String* @String.3 to i8*
	%vtpm.4 = icmp eq i8* %vtpm.2, %vtpm.3
	br i1 %vtpm.4, label %true.0, label %false.0

true.0:
	%vtpm.5 = load %Main*, %Main** %vtpm.0
...
ok.0:
	...
	%vtpm.9 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.8, i32 0, i32 7
	%vtpm.10 = load %Main* (%Main*,%String*) *, %Main* (%Main*,%String*) ** %vtpm.9
	%vtpm.11 = call %Main*(%Main*, %String* )%vtpm.10( %Main* %vtpm.5, %String* @String.2 )
	store %Main* %vtpm.11, %Main** %vtpm.1
	br label %end.0
...
ok.1:
	...
	%vtpm.18 = call %Main*(%Main*, %String* )%vtpm.17( %Main* %vtpm.12, %String* @String.1 )
...
entry:
	%vtpm.21 = alloca %Main*
	%vtpm.22 = getelementptr %_Main_vtable, %_Main_vtable* @_Main_vtable_prototype, i32 0, i32 1
	%vtpm.23 = load i32, i32* %vtpm.22
	%vtpm.24 = call i8*(i32 ) @malloc( i32 %vtpm.23 )
	%vtpm.25 = bitcast i8* %vtpm.24 to %Main*
	%vtpm.26 = icmp eq %Main* %vtpm.25, null
	br i1 %vtpm.26, label %abort, label %ok.2

ok.2:
	%vtpm.27 = getelementptr %Main, %Main* %vtpm.25, i32 0, i32 0
	store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.27
	store %Main* %vtpm.25, %Main** %vtpm.21
	ret %Main* %vtpm.25
