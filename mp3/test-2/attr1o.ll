...
@str.1 = internal constant [10 x i8] c"attr1o.cl\00"
...
ok.0:
	...
	%vtpm.11 = load %Main*, %Main** %vtpm.0
	%vtpm.12 = bitcast %Main* %vtpm.11 to %Object*
	ret %Object* %vtpm.12
...
entry:
	...
	%vtpm.17 = call i8*(i32 ) @malloc( i32 %vtpm.16 )
...
ok.1:
	...
	store %Main* %vtpm.18, %Main** %vtpm.14
	%vtpm.21 = getelementptr %Main, %Main* %vtpm.18, i32 0, i32 1
	store i32 0, i32* %vtpm.21
	%vtpm.22 = getelementptr %Main, %Main* %vtpm.18, i32 0, i32 1
	store i32 247, i32* %vtpm.22
	ret %Main* %vtpm.18
