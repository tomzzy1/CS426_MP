...
@String.1 = constant %String {
	%_String_vtable* @_String_vtable_prototype,
	i8* getelementptr ([6 x i8], [6 x i8]* @str.1, i32 0, i32 0)
}

@str.2 = internal constant [11 x i8] c"block_o.cl\00"
...
ok.0:
	...
	%vtpm.5 = getelementptr %_Main_vtable, %_Main_vtable* %vtpm.4, i32 0, i32 8
	%vtpm.6 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.5
	%vtpm.7 = call %Main*(%Main*, i32 )%vtpm.6( %Main* %vtpm.1, i32 890 )
	%vtpm.8 = load %Main*, %Main** %vtpm.0
	%vtpm.9 = bitcast %Main* %vtpm.8 to %Object*
	ret %Object* %vtpm.9
...
entry:
	%vtpm.11 = alloca %Main*
	%vtpm.12 = getelementptr %_Main_vtable, %_Main_vtable* @_Main_vtable_prototype, i32 0, i32 1
	%vtpm.13 = load i32, i32* %vtpm.12
	%vtpm.14 = call i8*(i32 ) @malloc( i32 %vtpm.13 )
	%vtpm.15 = bitcast i8* %vtpm.14 to %Main*
...
ok.1:
	...
	store %Main* %vtpm.15, %Main** %vtpm.11
	ret %Main* %vtpm.15
