...
@str.1 = internal constant [9 x i8] c"basic.cl\00"
...
entry:
	...
	%vtpm.2 = bitcast %Main* %vtpm.1 to %Object*
	ret %Object* %vtpm.2
...
entry:
	%vtpm.4 = alloca %Main*
	%vtpm.5 = getelementptr %_Main_vtable, %_Main_vtable* @_Main_vtable_prototype, i32 0, i32 1
	%vtpm.6 = load i32, i32* %vtpm.5
	%vtpm.7 = call i8*(i32 ) @malloc( i32 %vtpm.6 )
	%vtpm.8 = bitcast i8* %vtpm.7 to %Main*
	%vtpm.9 = icmp eq %Main* %vtpm.8, null
	br i1 %vtpm.9, label %abort, label %ok.0

ok.0:
	%vtpm.10 = getelementptr %Main, %Main* %vtpm.8, i32 0, i32 0
	store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.10
	store %Main* %vtpm.8, %Main** %vtpm.4
	ret %Main* %vtpm.8
