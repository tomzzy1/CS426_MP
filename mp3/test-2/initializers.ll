...
ok.0:
	...
	%vtpm.9 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.8
	%vtpm.10 = call %Main*(%Main*, i32 )%vtpm.9( %Main* %vtpm.4, i32 %vtpm.3 )
...
entry:
	...
	%vtpm.15 = load i32, i32* %vtpm.14
	%vtpm.16 = call i8*(i32 ) @malloc( i32 %vtpm.15 )
...
ok.1:
	...
	store %_Main_vtable* @_Main_vtable_prototype, %_Main_vtable** %vtpm.19
	store %Main* %vtpm.17, %Main** %vtpm.13
	%vtpm.20 = getelementptr %Main, %Main* %vtpm.17, i32 0, i32 1
	store %Main* null, %Main** %vtpm.20
	%vtpm.21 = getelementptr %Main, %Main* %vtpm.17, i32 0, i32 2
	store i32 0, i32* %vtpm.21
	%vtpm.22 = load %Main*, %Main** %vtpm.13
	%vtpm.23 = getelementptr %Main, %Main* %vtpm.22, i32 0, i32 2
	%vtpm.24 = load i32, i32* %vtpm.23
	%vtpm.25 = load %Main*, %Main** %vtpm.13
...
ok.2:
	...
	%vtpm.30 = load %Main* (%Main*,i32) *, %Main* (%Main*,i32) ** %vtpm.29
	%vtpm.31 = call %Main*(%Main*, i32 )%vtpm.30( %Main* %vtpm.25, i32 %vtpm.24 )
	%vtpm.32 = getelementptr %Main, %Main* %vtpm.17, i32 0, i32 1
	store %Main* %vtpm.31, %Main** %vtpm.32
	%vtpm.33 = getelementptr %Main, %Main* %vtpm.17, i32 0, i32 2
	store i32 12, i32* %vtpm.33
	ret %Main* %vtpm.17
